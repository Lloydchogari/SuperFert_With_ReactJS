...
const PageOne = () => {
  ...
  return (
    <>
      ...
      <div className="homepage">
        ...
        <div className="herosection">
          ...
          <div className="buttons">
            {/* ✅ Contact Us scrolls to 7th component */}
            <div className="btn1">
              <button onClick={() => scrollToSection("seven")}>
                Contact Us
              </button>
            </div>

            {/* ✅ Products scrolls to 5th component */}
            <div className="btn2">
              <button onClick={() => scrollToSection("green")}>
      ...
      {/*FIFTH COMPONENT*/}
      <div className="green" id="green"> {/* ✅ Add ID for Products */}
        <div className="div1">
      ...
      {/*SEVENTH COMPONENT*/}
      <div className="seven" id="seven"> {/* ✅ Add ID for Contact Us */}
